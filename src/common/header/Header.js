                ...
                <Modal ariaHideApp={false} 
                    ...
                    <TabContainer>
                        ...
                        <FormControl required>
                            ...
                            <FormHelperText className = {this.state.usernameRequired}><span className="red">required
                            </span></FormHelperText>
                        </FormControl><br/><br/>
                        ...
                        <FormControl required>
                            ...
                            <FormHelperText className = {this.state.passwordRequired}><span class="red">required
                            </span></FormHelperText>
                        </FormControl><br/><br/>
